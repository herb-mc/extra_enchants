...
public class EnchantmentMappings {
    ...
    static
    {
        ...
        enchantmentConfig.put("blaze_affinity:extra_damage_mult", blazeAffinityExtraDamage);
        ...
        enchantmentConfig.put("core_of_neptune:air_buff_threshold", coreNeptuneAirBuffThreshold);
        enchantmentConfig.put("core_of_neptune:attack_damage_max_buff", coreNeptuneMaxDamageBuff);
        enchantmentConfig.put("core_of_neptune:attack_speed_max_buff", coreNeptuneMaxAttackSpeedBuff);
        enchantmentConfig.put("core_of_neptune:movement_speed_max_buff", coreNeptuneMaxMoveSpeedBuff);
